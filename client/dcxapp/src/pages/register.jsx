...
const RegisterAsDeveloper=()=>{
    ...
    const handeleSubmit=(e)=>{
      ...
      setShowSuccessToast(true);
        ...
        .catch(err=>{setShowErrorToast(true);console.log(err);
      ...
      {errorMessage}
        ...
        <div className='container mt-2 mb-2'> 
            ...
            <label for="exampleFormControlInput1" class="form-label mb-0 fixed-label" >First Name</label>
                ...
                <div class="col-md-6 d-flex align-items-center gap-2 mb-3">
                <label for="exampleFormControlInput1" class="form-label mb-0 fixed-label">Password</label>
                <div>
                <input type="password" class={`form-control ${errors.password ? 'border-danger' : ''}`} id="exampleFormControlInput1" placeholder="Enter Password"onChange={(e)=>setPassword(e.target.value)} value={password}></input>
                {errors.password?<small class='red-text'>Min.8 chars numbers+letters+special char.</small>:''}
                </div>
                </div>
                <div class="col-md-6 d-flex align-items-center gap-2 mb-3">
                <label for="exampleFormControlInput1" class="form-label mb-0 fixed-label">Confirm Password</label>
                <div>
                <input type="password" class={`form-control ${errors.confirmPassword ? 'border-danger' : ''}`} id="exampleFormControlInput1" placeholder="confirm Password" onChange={(e)=>setConfirmPassword(e.target.value)} value={confirmPassword}></input>
                {errors.confirmPassword?<small class='red-text'>Enter matching Password.</small>:''}
                </div>
                </div>
                <div class="col-md-6 d-flex align-items-center gap-2 mb-3">
