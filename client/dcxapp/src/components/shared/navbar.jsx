  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <Link class="nav-link text-white fw-bold" to="/browse" state={{ skill: "" }}>Browse Developers</Link>
        </li>
        <li class="nav-item">
      ...
      {user===null?
        ...
        <button type="button" class="btn btn-outline-light text-white " data-bs-toggle="modal" data-bs-target="#exampleModal" >Login</button>
        :
        <><div class="d-flex text-white me-4" > Welcome Back, {user.firstName} </div>
        <button type="button" class="btn btn-outline-light text-white "onClick={()=>logOut()} >Logout</button></>
      }
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5 blue-text" id="exampleModalLabel">Login</h1>
      ...
      <input type="password" class="form-control" id="exampleInputPassword1" value={password} onChange={(e)=>setPassword(e.target.value)}></input>
          ...
          <div class="modal-footer justify-content-center" style={{ borderTop: 'none' }}>
          <button type="submit" class="btn btn-primary" data-bs-dismiss="modal" onClick={(e)=>loginUser(e)}>Submit</button>
          </div>
